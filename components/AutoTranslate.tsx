...
"Смена удалена.": "Зміну видалено.",
  "Удалить часы": "Видалити години",
"Удалить работу": "Видалити зміну",
"Удалить смену": "Видалити зміну",
"Удалить работу?": "Видалити зміну?",
"Удалить эту смену полностью? Это удалит часы и события.": "Видалити цю зміну повністю? Це видалить години та події.",
"Для удаления набери DELETE": "Для видалення введи DELETE",
"Удалить все отработанные часы по этой смене?": "Видалити всі відпрацьовані години за цією зміною?",
