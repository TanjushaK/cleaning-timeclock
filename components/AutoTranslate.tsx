...
const RU_TO_UK: Dict = {
  ...
  "Удалить смену полностью? Это удалит смену и все часы.": "Видалити зміну повністю? Це видалить зміну та всі години.",
  "Введите DELETE для подтверждения удаления смены": "Введіть DELETE для підтвердження видалення зміни",
