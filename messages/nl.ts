...
export const nl: Messages = {
  ...
  jobs: {
    title: "Diensten",
    scheduleTitle: "Mijn planning",
    thisWeek: "Deze week",
    plannedDay: "Gepland deze dag",
    plannedPeriod: "Gepland voor periode",
    workedDay: "Gewerkt deze dag",
    workedPeriod: "Gewerkt voor periode",
    worked: "Gewerkt",
    periodDay: "Dag",
    periodWeek: "Week",
    periodMonth: "Maand",
    periodCustom: "Datums kiezen",
    periodFrom: "Van",
    periodTo: "Tot",
    periodAll: "Alles geladen",
    plannedWeek: "Gepland deze week",
    plannedTotal: "Gepland totaal",
    noShiftsForDay: "Geen diensten voor deze dag.",
    ...
    shiftChatTitle: "Chat bij deze dienst",
    shiftChatShow: "Chat tonen",
    shiftChatHide: "Chat verbergen",
    shiftChatPlaceholder: "Bericht over deze dienst…",
    shiftChatSend: "Versturen",
    shiftChatSending: "Versturen…",
    shiftChatRefresh: "Vernieuwen",
    shiftChatLoading: "Laden…",
    shiftChatEmpty: "Nog geen berichten.",
    shiftChatErrLoad: "Berichten laden mislukt",
    shiftChatErrSend: "Bericht versturen mislukt",
  },
  profile: {
    title: "Profiel",
    role: "Rol",
