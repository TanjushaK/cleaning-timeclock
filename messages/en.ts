...
export const en: Messages = {
  ...
  jobs: {
    ...
    thisWeek: "This week",
    plannedDay: "Planned this day",
    plannedPeriod: "Planned for period",
    workedDay: "Worked this day",
    workedPeriod: "Worked for period",
    worked: "Worked",
    periodDay: "Day",
    periodWeek: "Week",
    periodMonth: "Month",
    ...
    shiftChatTitle: "Shift chat",
    shiftChatShow: "Show chat",
    shiftChatHide: "Hide chat",
    shiftChatPlaceholder: "Write a message about this shift…",
    shiftChatSend: "Send",
    shiftChatSending: "Sending…",
    shiftChatRefresh: "Refresh",
    shiftChatLoading: "Loading…",
    shiftChatEmpty: "No messages yet.",
    shiftChatErrLoad: "Could not load messages",
    shiftChatErrSend: "Could not send message",
  },
  profile: {
    title: "Profile",
    role: "Role",
