...
export const uk: Messages = {
  ...
  legal: {
    ...
    privacy: {
      ...
      p1: "Обробляються дані, необхідні для обліку часу у вашій організації: зміни, локації (якщо потрібно за посадою), контактні й профільні дані від вас або роботодавця.",
      p2: "Цілі зберігання та строки визначає організація. Запити на доступ, виправлення або видалення надсилайте роботодавцю або через сторінку підтримки щодо застосунку.",
      p3: "Застосовуються технічні та організаційні заходи захисту відповідно до налаштувань розгортання вашої організації.",
    },
    deleteAccount: {
