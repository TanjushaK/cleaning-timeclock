...
export async function POST(req: Request) {
  try {
    ...
    if (!site_id) throw new ApiError(400, 'site_id is required', AppApiErrorCodes.ASSIGNMENT_SITE_ID_REQUIRED)
    ...
    if (!row) throw new ApiError(403, 'No assignment for this site', AppApiErrorCodes.ASSIGNMENT_FOR_SITE_NOT_FOUND)
