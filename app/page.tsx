...
function statusPillClasses(s: string | null | undefined) {
  ...
  if (v === "in_progress") return "border-emerald-400/40 bg-emerald-500/20 text-emerald-100"
  if (v === "planned") return "border-amber-400/40 bg-amber-500/20 text-amber-100"
  if (v === "done") return "border-sky-400/40 bg-sky-500/20 text-sky-100"
